...
<div id="wrapper">
	...
	<div class="maincontainer">
		...
		<?php 
				...
				echo '<input class="inputform" value="'.$currentUserData['docname'].'" type="text" name="fullname" id="fullname" placeholder="Enter your full name here" required/>';
				...
				echo '<textarea class="inputarea" name="desc" id="desc" placeholder="Enter your description here" required/>'.$currentUserData['description'].'</textarea>';
